...
permalink: /ai-skills/ai-skills-part-2/
hidden: true
---

*This post shows empirical results for this idea ([part 1](/ai-skills/ai-skills-part-1/)) based on this methodology ([part 3](/ai-skills/ai-skills-part-3/)).*
...
![Instruction share by object cluster](/ai-skills/figures/2_7_object_label_share.png)
...
![Instructions by primary intent](/ai-skills/figures/2_1b_intent_frequency.png)
...
![Object cluster by primary intent](/ai-skills/figures/2_2_object_intent_bubble.png)
...
![Primary intent by discretion](/ai-skills/figures/2_3_intent_discretion_matrix.png)
...
![Constraint density by primary intent and discretion](/ai-skills/figures/2_6b_intent_discretion_constraint_quartiles.png)
...
![Decision vs constraint density for process-specification](/ai-skills/figures/2_8_process_spec_decision_constraint_matrix.png)
